...
console.log(now.month); // year and month are variables

var year = 2015;
var month = 7; // August (0 indexed)

var startDate = moment([year, month]); //Get the first and last day of the month

var firstDay = moment(startDate).startOf('month');
var endDay = moment(startDate).endOf('month'); // Create a range for the month we can iterate through

var monthRange = moment.range(firstDay, endDay);
console.log("getting month range");
console.log(monthRange); // Get all the weeks during the current month

var weeks = []; // monthRange.by('days', (moment)->
...
try {
  for (var _iterator = monthRange.by('days')[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    var day = _step.value;
    if (!weeks.includes(day.week())) weeks.push(day.week());
  }
} catch (err) {
...
console.log("weeks");
console.log(weeks); // // Create a range for each week
...
for (var i = 0; i < arrayLength; i++) {
  week = weeks[i]; //     //Create a range for that week between 1st and 7th day
...
console.log("caelndar doone");
console.log(calendar.length);
console.log(calendar);
/**
How to get a calendar???
lets think of datastructure
{
	
}

day 0 month 2 date 17
**/

},{"moment":3,"moment-range":2}],2:[function(require,module,exports){
